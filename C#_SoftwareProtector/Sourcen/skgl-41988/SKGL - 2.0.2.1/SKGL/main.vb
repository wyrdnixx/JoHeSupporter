...
Public Class Generate
    ...
    Public Function doKey(ByVal _timeLeft As Integer) As String
        Return doKey(_timeLeft, My.Computer.Clock.LocalTime)
    End Function
    ...
    Public Function doKey(ByVal _timeLeft As Integer, ByVal _creationDate As Date) As String
        ...
        Dim _stageThree As String = m._encrypt(_timeLeft, skc.Features, secretPhase, r.Next(0, 99999), _creationDate) ' stage one
