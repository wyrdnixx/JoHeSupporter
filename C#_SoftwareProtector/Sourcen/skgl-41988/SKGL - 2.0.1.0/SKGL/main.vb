...
Public Class Generate
    ...
    Public Function doKey(ByVal _timeLeft As Integer) As String
        If _timeLeft > 999 Then
            'Checking if the timeleft is NOT larger than 999. It cannot be larger to match the key-length 25.
            Throw New ArgumentException("The _timeLeft is larger than 999. It can only consist of three digits.")
        End If
        ...
        Dim _stageThree As String = m._encrypt(_timeLeft, skc.Features, secretPhase, r.Next(0, 99999)) ' stage one
...
Friend Class methods
    ...
    Protected Friend Function _encrypt(ByVal _days As Integer, ByVal _tfg() As Boolean, ByVal _secretPhase As String, ByVal ID As Integer) As String
        ...
        Dim _retInt As Integer = My.Computer.Clock.LocalTime.ToShortDateString.ToString.Replace("-", "") ' today
    ...
    End Function
    Protected Friend Function getEightByteHash(ByVal s As String) As Integer
        ...
        'to any length you want to
        Const MUST_BE_LESS_THAN As Integer = 1000000000
